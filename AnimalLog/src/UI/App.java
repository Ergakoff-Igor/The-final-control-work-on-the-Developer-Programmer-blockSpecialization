...
public class App {
    public static void ButtonClick() {
        ...
        try (Scanner in = new Scanner(System.in)) {
            while (true) {
                System.out.println("\nНавигация:");
                System.out.println("1 - предыдущий питомец    2 - следующий питомец");
                System.out.println("\nДействия:");
                System.out.println("3 - добавить питомца");
                System.out.println("4 - удалить питомца");
                System.out.println("5 - показать список всех питомцев");
                System.out.println("6 - поиск питомца");
                System.out.println("7 - добавить команду");
